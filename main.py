...
try:
    ...
    http = requests.get('https://raw.githubusercontent.com/ShiftyTR/Proxy-List/master/http.txt').text # HTTP
    https = requests.get('https://raw.githubusercontent.com/ShiftyTR/Proxy-List/master/https.txt').text # HTTPS
    socks4 = requests.get('https://raw.githubusercontent.com/ShiftyTR/Proxy-List/master/socks4.txt').text # Socks4
    socks5 = requests.get('https://raw.githubusercontent.com/ShiftyTR/Proxy-List/master/socks5.txt').text # Socks5
    proxies = requests.get('https://raw.githubusercontent.com/ShiftyTR/Proxy-List/master/proxy.txt').text # Mixed
